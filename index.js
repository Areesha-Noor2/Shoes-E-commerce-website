...
document.querySelectorAll('.featured-image-8').forEach(image_3 =>{
    image_3.addEventListener('click', () =>{
        var src = image_3.getAttribute('src');
        document.querySelector('.big-image-8').src = src;
    });
})
document.querySelectorAll('.featured-image-9').forEach(image_3 =>{
    image_3.addEventListener('click', () =>{
        var src = image_3.getAttribute('src');
        document.querySelector('.big-image-9').src = src;
    });
})
document.querySelectorAll('.featured-image-10').forEach(image_3 =>{
    image_3.addEventListener('click', () =>{
        var src = image_3.getAttribute('src');
        document.querySelector('.big-image-10').src = src;
    });
})
document.querySelectorAll('.featured-image-11').forEach(image_3 =>{
    image_3.addEventListener('click', () =>{
        var src = image_3.getAttribute('src');
        document.querySelector('.big-image-11').src = src;
    });
})
document.querySelectorAll('.featured-image-12').forEach(image_3 =>{
    image_3.addEventListener('click', () =>{
        var src = image_3.getAttribute('src');
